    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg bg-neutral-800 shadow-xl bg-white">
            <div className="flex items-center justify-between border-b border-neutral-700 p-4 border-neutral-300">
              <h3 className="text-lg font-semibold text-neutral-200 text-neutral-900">
                {t('settings.modalTitle')}
              </h3>
              <button
                onClick={handleClose}
                className="rounded p-2 transition-colors hover:bg-neutral-700 hover:bg-neutral-100"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
